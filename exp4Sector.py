...
from tools import run_hedging_with_money_constraint, run_with_money_constraint, total_return
...
PLOT_PATH = os.path.join(RESULT_DIR, "exp4SectorPlot.png")
RESULTS_CSV = os.path.join(RESULT_DIR, "exp4SectorPerformance.csv")
...
def main():
    ...
    for i, (etf, tickers) in enumerate(pairUps.items()):
        ...
        strat_returns, _ = run_hedging_with_money_constraint(
            sub_returns,
            WINDOWS[0],
            FREQS[0],
            MONEY_CONSTRAINT,
